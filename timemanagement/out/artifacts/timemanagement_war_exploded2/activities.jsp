<%@ page import="com.example.timemanagement.entity.Activity" %>
...
<div class="form-group">
    <div class="col-sm-9" align="right">
        <a href="/admin/profile" class="back_btn">Back to profile</a>
    </div>
</div>
</body>
</html>
...
<style>
    ...
    .btn {
        ...
        background: #324960; /* Серый цвет фона */
