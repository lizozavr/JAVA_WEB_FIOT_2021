...
@WebServlet(name = "GetAllActivitiesSortedByUsersAmountServlet", value = "/admin/activity/byUsersAmount")
public class GetAllActivitiesSortedByUsersAmountServlet extends HttpServlet {
    private final ActivityService activityService;

    public GetAllActivitiesSortedByUsersAmountServlet() throws SQLException {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (user.getRole().equals(Role.ADMIN)) {
            try {
                request.setAttribute("activities", activityService.getAllFilteredByAmountOfUsers());
