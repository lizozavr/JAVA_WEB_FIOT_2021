...
@WebServlet(name = "GetAllActivitiesSortedByNameServlet", value = "/admin/activity/byName")
public class GetAllActivitiesSortedByNameServlet extends HttpServlet {
    private final ActivityService activityService;

    public GetAllActivitiesSortedByNameServlet() throws SQLException {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (user.getRole().equals(Role.ADMIN)) {
            try {
                request.setAttribute("activities", activityService.getAllFilteredByName());
