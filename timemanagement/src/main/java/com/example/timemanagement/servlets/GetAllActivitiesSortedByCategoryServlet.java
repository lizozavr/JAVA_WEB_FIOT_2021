...
@WebServlet(name = "GetAllActivitiesSortedByCategoryServlet", value = "/admin/activity/byCategory")
public class GetAllActivitiesSortedByCategoryServlet extends HttpServlet {
    private final ActivityService activityService;

    public GetAllActivitiesSortedByCategoryServlet() throws SQLException {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (user.getRole().equals(Role.ADMIN)) {
            try {
                request.setAttribute("activities", activityService.getAllFilteredByCategory());
